...
if(isset($_POST['delete_url']))
{
    ...
    header("Location: Admin/admin_article_control.php");
...
if(isset($_POST['delete_challenge']))
{
   ...
   if ($success){
    ...
    header("Location: Admin/admin_monthly_challenge_control.php");
...
if (isset($_POST['challenge_submission'])) 
{
        ...
        $points_granted = mysqli_real_escape_string($db, $_POST['points_granted']);
...
function calcBMR($sex, $weight, $height, $age)
{
  ...
  if ($sex == 'M' || $sex == 'm' || $sex == 'MALE' || $sex == 'male')
  {
      ...
      $BMR = 88.362 + (13.397 * $weight) + (4.779 * $height) - (5.667 * $age);
      echo "<br> Your BMR = ";
...
function recommendDailyCaloryInput($BMR, $Activity_level, $Weight_goal)
{
  ...
  */
  ...
  else if ($Weight_goal == 1)
  {
      ...
      {
        echo "Error in value entered. Results will be incorrect. Please test again. Thanks!";
        $DailKilocaloriesNeeded = 0; 
      }
